...
user_email_address_dict = {1 : 'datta.tele@vidacapitalinc.com', 5 : 'ed.williams@vidacapitalinc.com', 6 : 'daniel.stokes@magna-life.com', 
                           ...
                           63 : "dj.carr@magnaservicing.com", 21 : "margie.contreras@magna-life.com", 22 : "john.hendrickson@vidacapitalinc.com",
                           24 : "megan.brown@vidacapitalinc.com", 25 : "lauren.hutchison@vidacapitalinc.com",  26 : "angelica.salas@vidacapitalinc.com", 
                           27 : "carrie.blackmon@vidacapitalinc.com", 55 : "ladonna.johnson@magnaservicing.com", 89: "Brandon.Wright@vidacapitalinc.com",
                           89: "Brandon.Wright@vidacapitalinc.com", 96: "brady.wright@magnaservicing.com"}
...
def find_folder(starting_dir, *sub_dirs):
    """
    joint: 0 = not joint, 1 = primary, 2 = secondary
    starting dir: dir_path
    sub_dirs: *args case_id, folder_name (Given or not)
    """
...
def add_primary_secondary_path(joint: int, med_dir: str):
    """we will have input names of folder for primary and secondary """
    joint =  int(joint)
    print(joint)
    print(type(joint))

    print("Med directory provided: ", med_dir)
    if med_dir:    
        ...
        if joint == 1:
            pri_dir =  os.path.join(med_dir, 'primary')
            return pri_dir
        
        if joint == 2:
            sec_dir =  os.path.join(med_dir, 'secondary')
            return sec_dir


# def find_folder_version_2(starting_dir: str, case_id: str, folder_name: str)
...
#         print("POST DATA: ", post_data)
        ...
        if not post_data_df.empty:
            ...
            post_data_df['med_dir'] = post_data_df.apply(lambda x: add_primary_secondary_path(x.joint, x.med_dir), axis=1)
